...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="customer_home.php" id="label">Home</a>
        <a href="customer_transactions.php" id="label">My Transactions</a>
        <a href="beneficiary.php" id="label" >Transfer Funds</a>
        <a href="atm_simulator.php" id="label">ATM Simulator</a>
        <a href="#" id="label">Contact us</a>
    </div>
