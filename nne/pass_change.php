...
<body>
    <form class="add_customer_form" action="pass_change_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div class="flex-container-radio">
                <div class="container">
                    ...
                    <label id="radio-label" for="password-radio"><span class="radio" >Login Password</span></label>
                </div>
                <div class="container">
        ...
        <div class="flex-container">
            <div  class=container>
                <label>Enter Current Password/PIN :</b></label><br>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <label>Re-Enter New password/PIN :</b></label><br>
