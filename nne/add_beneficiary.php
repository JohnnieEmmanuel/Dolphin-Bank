    ...
    <form class="add_customer_form" action="add_beneficiary_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="first_name" size="30" type="text" required />
            </div>
            <div  class=container>
                <label>Last Name :</b></label><br>
                <input name="last_name" size="30" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            <div  class=container>
                <label>Account Number :</b></label><br>
                <input name="account_number" size="30" type="text" required />
            </div>
            ...
            <div  class=container>
                ...
                <input name="phone_number" size="30" type="text" required />
            </div>
        </div>
